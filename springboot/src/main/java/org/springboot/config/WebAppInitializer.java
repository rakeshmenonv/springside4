...
public class WebAppInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext)
		...
		servletContext.addFilter("openEntityManagerInViewFilter", openEntityManagerInViewFilter).addMappingForServletNames(null, false, "/*");
		...
		servletContext.addServlet("StaticContentServlet",new StaticContentServlet()).addMapping("/download");
